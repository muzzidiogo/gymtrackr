...
export default function Comunidade() {
    ...
    return (
        <>
            <Head>
                <title>Comunidade - GymTrackr</title>
                <meta name="description" content="Conecte-se com outros usuários do GymTrackr" />
            </Head>
            <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 to-gray-800 text-gray-100">
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <nav className="flex items-center justify-between py-6">
                            ...
                            <div className="hidden md:flex md:items-center space-x-8">
                                ...
                                <a href="/User/Comunidade" className="font-medium text-indigo-400 transition-colors">Comunidade</a>
                            </div>
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden bg-gray-800 rounded-lg shadow-lg p-4 mx-4 mb-4 border border-gray-700 mt-2">
                        <div className="flex flex-col space-y-4">
                            ...
                            <a href="/User/Comunidade" className="font-medium text-indigo-400 transition-colors py-2">Comunidade</a>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 flex-grow">
                    ...
                    <div className="flex items-center text-sm text-gray-400 mb-8">
                        ...
                        <span className="text-indigo-400">Comunidade</span>
                    </div>

                    {/* Page Header */}
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-white mb-2">Comunidade</h1>
                        <p className="text-gray-400">Conecte-se com outros atletas, compartilhe conquistas e busque inspiração</p>
                    </div>
                    ...
                    <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-700 shadow-xl overflow-hidden p-8 text-center">
                        <div className="max-w-2xl mx-auto">
                            ...
                            <p className="text-gray-300 mb-6">
                                Estamos trabalhando para criar uma comunidade vibrante onde você poderá 
                                compartilhar seus treinos, conquistas e se conectar com outros usuários 
                                do GymTrackr. Em breve, você poderá participar de desafios, encontrar parceiros 
                                de treino e obter motivação da nossa comunidade fitness.
                            </p>
